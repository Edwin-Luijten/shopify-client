...
class ProductsTest extends SimpleResource
{
    ...
    {
        $item = static::$client->products->variants->metafields->create($ids['productId'], $ids['id'], $this->postProductMetafield);
    ...
    {
        $item = static::$client->products->variants->metafields->update($ids['productId'], $ids['variantId'], $ids['id'], $this->putProductMetafield);
